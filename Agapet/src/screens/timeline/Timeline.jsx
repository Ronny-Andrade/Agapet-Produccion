                        ...
                        <View style={style.iconCaracte5i22}>
                            ...
                            <SafeAreaView style={style.container2}>
                                <TouchableWithoutFeedback onPress={onShowPopup5}>
                                    ...
                                    <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                        <Text style={{ color: colorEntrega, fontSize: width * 0.035, marginBottom: '1%' }}> Entrega de mascota</Text>
                                        <Icon
                                            size={width * 0.05}
                        ...
                        <View style={style.iconCaracte5i2}>
                            ...
                            <SafeAreaView style={style.container2}>
                                <TouchableWithoutFeedback onPress={onShowPopup3}>
                                    ...
                                    <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                        <Text style={{ color: colorVisita, fontSize: width * 0.035, marginBottom: '1%' }}> Visita a domicilio</Text>
                                        <Icon
                                            size={width * 0.05}
                                            name='arrow-right-bold'
                                            color={colorVisita} />
                        ...
                        <View style={style.iconCaracte5i}>
                            ...
                            <SafeAreaView style={style.container2}>
                                <TouchableWithoutFeedback onPress={onShowPopup}>
                                    ...
                                    <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                        <Text style={{ color: colorFormulario, fontSize: width * 0.035, marginBottom: '1%' }}> Formulario</Text>
                                        <Icon
                                            size={width * 0.05}
                                            name='arrow-right-bold'
